    ...
    <>
            ...
            return (
              <tr className="" key={user.id}>
                ...
                <td className="p-2">
                  <div>
                    <button
                      className="bg-blue-400 m-2 p-2 px-4 rounded-md font-semibold text-[12px]"
      ...
      <div className="w-[80%] md:w-[60%] lg:w-[20%]  m-auto bg-slate-200 rounded-lg shadow-md">
        <div className="p-2 flex flex-col ">
          ...
          {show ? (
            <button
              className="bg-blue-300 m-1 p-2 text-[12px] font-semibold rounded-lg text-slate-600"
            ...
            <button
              className="bg-green-300 m-1 p-2 text-[12px] font-semibold rounded-lg text-slate-600"
